      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <a href="{{ route('admin.ticket') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            <span class="flex-1 ms-3 whitespace-nowrap">Ticket anda</span>
          </a>
        </li>
        <li>
          <a href="{{ route('admin.event') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            <span class="flex-1 ms-3 whitespace-nowrap">Event Anda</span>
          </a>
        </li>
        <li>
          <a href="{{ route('admin.discount') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            <span class="flex-1 ms-3 whitespace-nowrap">Diskon Anda</span>
          </a>
        </li>
        <li>
          <a href="{{route('admin.talent')}}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            <span class="flex-1 ms-3 whitespace-nowrap">Talent Anda</span>
          </a>
        </li>
        <li>
