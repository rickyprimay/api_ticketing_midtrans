        ...
        @else
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                @foreach ($orders as $order)
                    <!-- card -->
                    <div class="flex flex-col items-center bg-white border border-black rounded-lg shadow md:flex-row md:max-w-2xl hover:bg-gray-100">
                        <div class="flex flex-col justify-between p-4 leading-normal w-full">
                            ...
                            <button data-modal-target="small-modal" data-modal-toggle="small-modal" class="bg-[#454545] text-white px-4 py-2 rounded" type="button">
                                Invoice</button>
                    ...
                    <!-- end card -->
                    <!-- Small Modal -->
<div id="small-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-screen max-h-full">
