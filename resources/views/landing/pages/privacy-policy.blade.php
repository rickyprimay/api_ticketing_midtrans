...
@section('content')
    <div class="p-4">
        ...
        <div class="lg:mx-20">
            ...
            <h3 class="mt-4 font-semibold">1.1. Informasi Pribadi</h3>
            ...
            <h3 class="mt-4 font-semibold">1.2. Informasi Pembayaran</h3>
            <ul class="list-disc pl-5">
            ...
            <h3 class="mt-4 font-semibold">1.3. Informasi Teknis</h3>
            <ul class="list-disc pl-5">
            ...
            <h3 class="mt-4 font-semibold">1.4. Informasi Tambahan</h3>
            <ul class="list-disc pl-5">
            ...
            <p class="mt-2">Pengumpulan dan pemrosesan data pribadi Anda dilakukan berdasarkan ketentuan hukum yang berlaku, termasuk:</p>
            <ul class="list-disc pl-5">
            ...
            <p class="mt-2">Kami menggunakan informasi yang kami kumpulkan untuk berbagai tujuan berikut:</p>

            <h3 class="mt-4 font-semibold">3.1. Penyediaan Layanan</h3>
            <ul class="list-disc pl-5">
            ...
            <h3 class="mt-4 font-semibold">3.2. Komunikasi</h3>
            <ul class="list-disc pl-5">
            ...
            <h3 class="mt-4 font-semibold">3.3. Pengembangan dan Analisis</h3>
            <ul class="list-disc pl-5">
            ...
            <h3 class="mt-4 font-semibold">3.4. Keamanan dan Kepatuhan</h3>
            <ul class="list-disc pl-5">
            ...
            <p class="mt-2">Kami dapat mengungkapkan informasi pribadi Anda kepada pihak ketiga dalam kondisi berikut:</p>

            <h3 class="mt-4 font-semibold">4.1. Penyedia Layanan Pihak Ketiga</h3>
            <ul class="list-disc pl-5">
            ...
            <h3 class="mt-4 font-semibold">4.2. Kewajiban Hukum dan Penegakan Hukum</h3>
            <ul class="list-disc pl-5">
            ...
            <h3 class="mt-4 font-semibold">4.3. Transfer Bisnis</h3>
            <p class="mt-2">Dalam hal terjadi merger, akuisisi, atau penjualan sebagian atau seluruh aset kami, informasi pribadi Anda mungkin menjadi salah satu aset yang ditransfer kepada pihak ketiga.</p>

            <h2 class="mt-8 font-bold">5. Keamanan Data Pribadi</h2>
            <p class="mt-2">Kami berkomitmen untuk menjaga keamanan data pribadi Anda melalui langkah-langkah berikut:</p>

            <h3 class="mt-4 font-semibold">5.1. Teknologi Keamanan</h3>
            <ul class="list-disc pl-5">
            ...
            <h3 class="mt-4 font-semibold">5.2. Kebijakan dan Prosedur Internal</h3>
            <ul class="list-disc pl-5">
            ...
            <p class="mt-2">Meskipun kami telah mengambil langkah-langkah untuk melindungi informasi pribadi Anda, perlu diingat bahwa tidak ada metode penyimpanan atau transmisi data yang sepenuhnya aman. Oleh karena itu, kami tidak dapat menjamin keamanan absolut data Anda.</p>

            <h2 class="mt-8 font-bold">6. Hak Anda sebagai Pemilik Data</h2>
            <p class="mt-2">Berdasarkan UU PDP, Anda memiliki hak-hak tertentu terkait data pribadi Anda, termasuk:</p>

            <h3 class="mt-4 font-semibold">6.1. Hak untuk Mengakses</h3>
            <p class="mt-2">Anda berhak untuk meminta informasi tentang data pribadi yang kami miliki tentang Anda dan untuk memperoleh salinan dari data tersebut.</p>

            <h3 class="mt-4 font-semibold">6.2. Hak untuk Mengoreksi</h3>
            <p class="mt-2">Anda dapat meminta kami untuk memperbarui atau memperbaiki data pribadi Anda jika terdapat ketidakakuratan atau perubahan dalam data tersebut.</p>

            <h3 class="mt-4 font-semibold">6.3. Hak untuk Menghapus</h3>
            <p class="mt-2">Anda dapat meminta penghapusan data pribadi Anda dalam kondisi tertentu, misalnya jika data tersebut tidak lagi diperlukan untuk tujuan pengumpulannya.</p>

            <h3 class="mt-4 font-semibold">6.4. Hak untuk Menolak Pemrosesan</h3>
            <p class="mt-2">Anda berhak untuk menolak pemrosesan data pribadi Anda jika pemrosesan tersebut dilakukan berdasarkan kepentingan sah kami atau untuk tujuan pemasaran langsung.</p>

            <h3 class="mt-4 font-semibold">6.5. Hak untuk Menarik Persetujuan</h3>
            <p class="mt-2">Jika pemrosesan data pribadi Anda didasarkan pada persetujuan Anda, Anda berhak untuk menarik persetujuan tersebut kapan saja. Penarikan persetujuan tidak mempengaruhi keabsahan pemrosesan berdasarkan persetujuan sebelum penarikan.</p>

            <h2 class="mt-8 font-bold">7. Penggunaan Cookie dan Teknologi Serupa</h2>
            <p class="mt-2">Kami menggunakan cookie dan teknologi serupa untuk meningkatkan pengalaman pengguna di situs kami. Ini termasuk:</p>

            <h3 class="mt-4 font-semibold">7.1. Jenis Cookie yang Digunakan</h3>
            <ul class="list-disc pl-5">
            ...
            <h3 class="mt-4 font-semibold">7.2. Mengelola Cookie</h3>
            <p class="mt-2">Anda dapat mengelola preferensi cookie Anda melalui pengaturan browser Anda. Menonaktifkan cookie tertentu dapat mempengaruhi fungsionalitas situs kami dan pengalaman pengguna Anda.</p>

            <h2 class="mt-8 font-bold">8. Retensi Data</h2>
            <p class="mt-2">Kami hanya menyimpan data pribadi Anda selama diperlukan untuk memenuhi tujuan pengumpulannya atau selama diwajibkan oleh hukum. Setelah periode retensi berakhir, kami akan menghapus atau menganonimkan data Anda sesuai dengan kebijakan retensi data kami.</p>

            <h2 class="mt-8 font-bold">9. Transfer Internasional</h2>
            <p class="mt-2">Jika kami mentransfer data pribadi Anda ke luar Indonesia, kami akan memastikan bahwa data tersebut dilindungi dengan standar keamanan yang setara dengan yang diharuskan oleh UU PDP. Transfer data akan dilakukan sesuai dengan persyaratan peraturan yang berlaku.</p>

            <h2 class="mt-8 font-bold">10. Kebijakan Privasi untuk Anak-anak</h2>
            <p class="mt-2">Layanan kami tidak ditujukan untuk anak-anak di bawah usia 13 tahun. Kami tidak secara sadar mengumpulkan informasi pribadi dari anak-anak tanpa izin dari orang tua atau wali. Jika kami mengetahui bahwa kami telah mengumpulkan data pribadi dari anak-anak tanpa persetujuan yang diperlukan, kami akan mengambil langkah untuk menghapus data tersebut.</p>

            <h2 class="mt-8 font-bold">11. Perubahan Kebijakan Privasi</h2>
            <p class="mt-2">Kami dapat memperbarui Kebijakan Privasi ini dari waktu ke waktu untuk mencerminkan perubahan pada praktik kami atau untuk mematuhi peraturan yang berlaku. Kami akan memberi tahu Anda tentang perubahan penting melalui email atau pemberitahuan di situs kami.</p>
        </div>
    </div>
@endsection
